...
public class Calcular extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>O valor do fornecimento é ..............: R$ "+ obj_energia.getFornecimento() +"</h2>");
            out.println("<h2>O valor do icms é ......................: R$ "+ obj_energia.getIcms() +"</h2>");
            out.println("<h2>O valor do cofins é ....................: R$ "+ obj_energia.getCofins() +"</h2>");
            out.println("<h2>O valor do pis/pasep é .................: R$ "+ obj_energia.getPispasep() +"</h2>");
            out.println("<h2>O valor do icms cofins é ...............: R$ "+ obj_energia.getIcmscofins() +"</h2>");
            out.println("<h2>O valor do icms pis/pasep é ............: R$ "+ obj_energia.getIcmspispasep() +"</h2>");
            out.println("<h2>O valor da Fatura é ....................: R$ "+ obj_energia.getFatura() +"</h2>");
            out.println("</body>");
            out.println("</html>");
        }
    }
